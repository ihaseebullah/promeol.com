...
import ClientImg05 from "@/public/images/client-logo-05.webp";
    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6">
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
        ...
        <div>
          ...
          {/* Cards */}
          <div
            className="mx-auto grid max-w-sm items-start gap-6 sm:max-w-none sm:grid-cols-2 lg:grid-cols-5"
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2">
        <div className="flex justify-center items-center gap-3" style={{minHeight:100}}>
          <Image src={testimonial.clientImg}  height={100} alt="Client logo" />
        </div>
