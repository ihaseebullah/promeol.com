                ...
                {showForm ? (
                  <form onSubmit={handleFormSubmit}>
                    ...
                    <div className="mb-4">
                      ...
                      <DatePicker
                        className="mt-1 block lg:w-[465px] md:w-[465px] sm:w-full rounded-md bg-gray-700 text-gray-200 border-gray-600 focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                        selected={startDate}
